...
Automated agentic workflow that scrapes 60 Reddit communities 3× per day,
...
| Afternoon | 1:00 PM | Scrapes all 60 subs → Top 10 problems |
| Evening | 6:00 PM | Scrapes all 60 subs → Top 10 problems |
| **Final Report** | **8:30 PM** | Validates all 3 reports → Email to you |
...
| Afternoon (1 PM) | 8 AM today — no posts missed between morning and afternoon |
| Evening (6 PM) | 1 PM today — no posts missed between afternoon and evening |
...
This will run morning + afternoon + evening scrapes, commit JSON reports, and send your final email tonight.
...
│       ├── scrape-afternoon.yml  ← 1:00 PM Central
